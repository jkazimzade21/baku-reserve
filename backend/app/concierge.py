...
class ConciergeEngine:
    ...
    def _interpret_prompt(self, prompt: str, locale: str | None) -> IntentData:
        ...
        schema_hint = (
            "Return JSON with keys: language (ISO code), vibes (array of ambiance words), "
            "cuisines (array), locations (array), price (cheap|moderate|premium|any), "
            "special (array of notable requests), avoid (array)."
        )
        request_text = (
