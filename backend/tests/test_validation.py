...
def test_arrival_intent_notes_trimmed_and_limited():
    request = ArrivalIntentRequest(lead_minutes=15, notes="  Arriving in 10 minutes  ")
    assert request.notes == "Arriving in 10 minutes"
